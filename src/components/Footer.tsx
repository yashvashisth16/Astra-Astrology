    ...
    <footer className="footer">
      <div className="container footer-content">
        <div className="footer-brand reveal from-left">
          <Link href="/" className="logo" style={{ lineHeight: "1.2", display: "inline-block" }}>Parasharr Divine Astrology <br /><span style={{ fontSize: "0.55em", opacity: 0.9, display: "block", marginTop: "-2px" }}>by Dr Priti</span></Link>
      ...
      <div className="container footer-bottom">
        <p>&copy; 2026 Parasharr Divine Astrology. All rights reserved.</p>
      </div>
    </footer>
  );
}
